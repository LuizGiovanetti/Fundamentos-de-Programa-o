...
void gerarVetorSemRepInteiroDe1aLimite(int vet[], int tam, int limite)
{
    int i, j;
    srand(time(NULL));
...
void transformarASCCI(char texto[],int tam, int vet[])
{
    int i;
    for(i=0; i<=tam; i++)
    {
...
void imprimirVetorOrdenado(int vet[], int tam)
{
    int i, aux, j;
    for(i=0; i<tam; i++)
    {
